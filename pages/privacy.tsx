        ...
        <div className={styles.page}>
          <div className={styles.header}>
            <div className={styles.container}>
              <p className={styles.title}>Privacy Policy for No-Show Bus Cork</p>
            </div>
          </div>
            ...
            <div className={styles.container}>
              <div className={styles.translationslistcontainer}>
                ...
                <p>
                  ...
                  of the{" "}
                  <Link href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to No-Show Bus Cork, accessible from{" "}
                      <Link href="https://nobus.omiti.net" rel="external nofollow noopener" target="_blank">
                        https://nobus.omiti.net
                      </Link>
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      The purpose of these Cookies is to provide You with a more personalized
                ...
                <p>
                  ...
                  please visit our <Link href="/cookie-policy">Cookie Policy</Link>.
                </p>
              </div>
            </div>
          </div>
